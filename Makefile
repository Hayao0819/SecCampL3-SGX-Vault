...
## コンパイル時に使用するC/C++のソースを列挙
App_Cpp_Files := Server_App/server_app.cpp Server_App/error_print.cpp Server_App/server_router.cpp Server_App/server_service.cpp Server_App/server_sgx.cpp Server_App/server_ra.cpp Server_App/utils.cpp common/base64.cpp common/debug_print.cpp common/hexutil.cpp common/crypto.cpp
